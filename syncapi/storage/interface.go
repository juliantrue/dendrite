...
type Database interface {
	...
	// will not create one.
	IncrementalSync(ctx context.Context, res *types.Response, device userapi.Device, fromPos, toPos types.StreamingToken, numRecentEventsPerRoom int, wantFullState bool, nextBatch *types.StreamingToken) (*types.Response, error)
	...
	CompleteSync(ctx context.Context, res *types.Response, device userapi.Device, numRecentEventsPerRoom int, nextBatch *types.StreamingToken) (*types.Response, error)
